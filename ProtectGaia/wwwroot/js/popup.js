...
//    steps.push(['.printer left', 'Print Report', 'Take the tour to learn more about how to use the Sales Performance Tool']);
...
//    steps.push(['.prog bottom', 'Progress', 'There are 4 cards which will update after the completion of every task and will show you the current level you are in, the number of pending and completed tasks for that level, and  the total score for all the tasks from all the levels completed till now']);
